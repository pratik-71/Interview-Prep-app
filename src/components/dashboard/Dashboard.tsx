    ...
    <div className="min-h-screen" style={{ backgroundColor: secondaryColor }}>
      <div className="max-w-5xl mx-auto py-6 md:py-8 lg:py-10 px-4 md:px-5 lg:px-6">
        ...
        <div className="mb-8 md:mb-10 lg:mb-12">
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-7 lg:p-8 border border-gray-100">
            <div className="flex items-center space-x-4 md:space-x-5 lg:space-x-6 mb-6 md:mb-7">
              ...
              <div>
                <h1 className="text-2xl md:text-2xl lg:text-3xl font-bold" style={{ color: tertiaryColor }}>
                  Welcome back, {user?.username || 'User'}!
                </h1>
                <p className="text-base md:text-base lg:text-lg" style={{ color: tertiaryColor }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 lg:gap-5">
              <div className="bg-gray-50 rounded-xl p-4 md:p-5 lg:p-6">
                <div className="flex items-center space-x-3 md:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-lg lg:text-xl font-semibold" style={{ color: tertiaryColor }}>
              ...
              <div className="bg-gray-50 rounded-xl p-4 md:p-5 lg:p-6">
                <div className="flex items-center space-x-3 md:space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-base md:text-lg lg:text-xl font-semibold" style={{ color: tertiaryColor }}>0</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-5 lg:gap-6 items-stretch">
          <div className="bg-white rounded-2xl shadow-lg p-5 md:p-6 lg:p-7 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
            ...
            <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-2 md:mb-3" style={{ color: tertiaryColor }}>
              Practice Questions
            </h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col">
