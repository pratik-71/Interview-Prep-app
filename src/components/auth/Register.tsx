        ...
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-7 lg:p-8 border border-gray-100">
          <form className="space-y-4 md:space-y-5 lg:space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3 md:space-y-3 lg:space-y-4">
              ...
              <div>
                <label htmlFor="username" className="block text-sm font-medium mb-1 md:mb-1" style={{ color: tertiaryColor }}>
                  Username
                </label>
                <input
                  id="username"
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium mb-1 md:mb-1" style={{ color: tertiaryColor }}>
                  Confirm Password
                </label>
                <input
                  id="confirmPassword"
